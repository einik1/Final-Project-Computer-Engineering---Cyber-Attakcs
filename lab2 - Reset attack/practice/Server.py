...
while True:
    ...
    for current_socket in rlist:
		...
		if data == "":
		  ...
		  break
		print 'The massage from the client is: {}\n'.format(data)
		counters[current_socket][0] += 1
            ...
            if data == "bye":
                ...
                if data == "time":
                    ...
                    messages_to_send.append((current_socket, 'my id is: {}'.format("xxxxxxxxx")))
		elif data == "name":
		    messages_to_send.append((current_socket, 'my name is: {}'.format("YYYYY")))
		elif data == "getmygrade":
                    messages_to_send.append((current_socket, 'your grade is {}'.format(str(random.randint(0, 100)))))
                else:
